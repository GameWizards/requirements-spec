...
% TODO: remove numbers from display of subsubsections
% less neurotic look.
...
%MDFRAMED%\begin{mdframed}
    ...
    \begin{description}
        \item[Entry conditions] A puzzle scene must be loaded and solve mode
            must be activated.
        \item[Exit conditions] Will go back to game menu. If the game is
            over, an overview of results is shown and
        \item[Participating Actors] Online player and local player
        \item[Flow of events]:
            \begin{enumerate}
                \item User creates a game, selects number of players and game

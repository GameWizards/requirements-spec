...
Boundary objects are those that the user will be using directly through the user interface. These objects are responsible for displaying the correct display to the user and 

...
Boundary objects are those that the user will be using directly through the user interface. These objects are responsible for displaying the correct buttons for the user and directing the player to the type of game play they selected.
